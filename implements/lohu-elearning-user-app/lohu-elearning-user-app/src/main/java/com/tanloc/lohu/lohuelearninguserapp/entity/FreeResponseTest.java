...
public class FreeResponseTest {
    ...
    @OneToMany(mappedBy = "freeResponseTest", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    List<FreeResponseQuestion> freeResponseQuestions;
}
